...
| FR-10 | Support explicit content sources and well-defined fallback behavior. | Partial: custom Content Source contract implemented; URL source and fallback pending |
