...
ADRs record durable technical decisions. Accepted ADRs are not rewritten to hide a change; supersede them with a new ADR and link both records.
...
| [0003](./0003-compose-content-sources-with-actions.md) | Compose explicit Content Sources with Actions | Proposed |
